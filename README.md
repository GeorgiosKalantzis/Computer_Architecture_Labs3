...
* Dynamic Power Dissipation
  ...
  * **Switching**
     Ορίζεται ως η απώλεια ισχύος που οφείλεται στην φόρτιση και στην εκφόρτιση της πύλης του τρανζίστορ κατά την μετάδοση του σήματος και εξάρταται εκτός των υπολοίπων από την      συχνότητα του ρολογιού και ενός παράγοντα μεταγωγής a.

  * **Short Circuit**
     Οφείλεται στο σταθερό DC ρεύμα που εμφανίζεται στο CMOS κατά την μετάβαση σήματος όταν το σήμα εισόδου αλλάζει τάση.

* **Static Power Dissipation**

  * Subthreshold Leakage Current
     Οφείλεται στο ρεύμα που διαρρέεται κατα την διάρκεια της περιοχής αποκοπής του τρανζίστορ.

  * Gate Leakage Current
     Οφείλεται στο ρεύμα που διαρρέται από την πύλη οξειδίου
